            ...
            {isFillBlank ? (
              ...
              >
                <input
                  ...
                  maxLength={100}
                  className={`
                    w-full h-14 px-4 rounded-xl border bg-transparent text-center
                    text-sm font-mono tracking-wide outline-none transition-all duration-150
                    placeholder:text-muted-foreground/40
                    ${isAnswered
                      ? isCorrect
                        ? "border-emerald-500/50 bg-emerald-500/6 text-emerald-600 dark:text-emerald-400"
                        : "border-rose-500/50 bg-rose-500/6 text-rose-600 dark:text-rose-400"
